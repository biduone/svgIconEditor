define("assets/magix/jquery.ui.widget", ["jquery"], function(t, e, i) {
    var n;
    n = function(d) {
      var s, i = 0, a = Array.prototype.slice;
      d.cleanData = (s = d.cleanData,
      function(t) {
      ...
      d.each({
        ...
        d.Widget.prototype["_" + o] = function(e, t, i) {
          ...
          n && d.effects && d.effects.effect[s] ? e[o](t) : s !== o && e[s] ? e[s](t.duration, t.easing, i) : e.queue(function(t) {
            d(this)[o](),
            i && i.call(e[0]),
            t()
          })
    ...
    ,
    "function" == typeof define && define.amd ? define(["jquery"], n) : n("object" == typeof e ? t("jquery") : jQuery)
  });
