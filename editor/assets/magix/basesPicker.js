define("assets/magix/basesPicker", ["magix", "$", "assets/magix/basesMonitor"], function(o, e, t) {
    var r = o("magix")
      , d = o("$")
      , p = o("assets/magix/basesMonitor");
    r.applyStyle("mp-60f", ".mp-60f-picker{z-index:10000;width:227px;background:#fff;position:absolute;display:none;box-shadow:0 4px 10px 0 rgba(0,0,0,.1),0 3px 5px 0 rgba(0,0,0,.05),0 0 0 1px rgba(0,0,0,.09098)}.mp-60f-left:after,.mp-60f-left:before{border:8px solid transparent;border-top:8px solid #fff;width:0;height:0;position:absolute;bottom:-16px;left:8px;content:' '}.mp-60f-left:before{border-width:8px;border-top-color:#888}.mp-60f-right:after,.mp-60f-right:before{border:8px solid transparent;border-top:8px solid #fff;width:0;height:0;position:absolute;bottom: -16px;right:8px;content:' '}.mp-60f-right:before{border-width:8px;border-top-color:#888}");
    t.exports = r.View.extend({
      ...
      show: function() {
        ...
        r = "left" == i.$dock ? e.left : e.left + r.outerWidth() - o.outerWidth(),
        o.css({
          left: r,
          top: t
        }))
