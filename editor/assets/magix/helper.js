define("assets/magix/helper", ["assets/magix/dialog", "assets/magix/globaltip", "assets/magix/tip", "jquery", "assets/magix/i18n"], function(t, e, n) {
    var i = t("assets/magix/dialog")
      , o = t("assets/magix/globaltip")
      , a = t("assets/magix/tip")
      , r = t("jquery")
      , s = t("assets/magix/i18n")
      , c = {
      ...
      MOST_USE_COLOR: ["d81e06", "f4ea2a", "1afa29", "1296db", "13227a", "d4237a", "ffffff", "e6e6e6", "dbdbdb", "cdcdcd", "bfbfbf", "8a8a8a", "707070", "515151", "2c2c2c"],
      globalDialog: null,
      showTip: function(t) {
        a.show(t)
      },
      ...
      addIconsToHistory: function(t) {
        ...
        }), t = this.getItem(this.HISTORY_DOWNLOAD_KEY) || [], e = e.concat(t), n = [], o = {}, i = 0; i < e.length; i++)
          o[e[i].id] || (n.push(e[i]),
          o[e[i].id] = 1);
    ...
    c = r.extend(c, {
      ...
      createCookie: function(t, e, n) {
        var o = n ? ((o = new Date).setTime(o.getTime() + 24 * n * 60 * 60 * 1e3),
    ...
    c = r.extend(c, {
      ...
      renderChangyan: function(i, a) {
        r.getScript("//changyan.sohu.com/upload/changyan.js").done(function(t, e) {
          var n = document.createElement("div");
          ...
          var o = function() {
            (r("#MZAD_POP_PLACEHOLDER").length || r("#pop_ad").length) && (r("#MZAD_POP_PLACEHOLDER").remove(),
            r("#pop_ad").remove()),
            setTimeout(o, 2e3)
          };
          setTimeout(o, 2e3)
    ...
    c = r.extend(c, {
      getCpFn: function(p) {
        return "name" === p || "font_class" === p ? function(t, e) {
          t = t[p].toString(),
          e = e[p].toString();
          var n = /[0-9]+/g
            , o = t.match(n)
          ...
          for (var a = 0, r = Math.min(o.length, i.length); a < r; a++) {
            ...
            if (s != c || l != d)
              return t.localeCompare(e);
            if (f !== u)
              return h == g ? u.lastIndexOf(g + "") - f.lastIndexOf(h + "") : h - g;
            if (a == r - 1)
              return t.substring(s).localeCompare(e.substring(c));
            t = t.substring(s + f.length),
            e = e.substring(s + f.length)
          }
        }
        : function(t, e) {
          return t[p] < e[p] ? 1 : -1
    ...
    c = r.extend(c, {
      showDownloadDialog: function(t) {
        c.showDialog("app/views/common/download_icon", {
          viewOptions: t,
          width: 910,
          height: 631,
      ...
      showEditDialog: function(t) {
        c.showDialog("assets/magix/edit_view", {
          viewOptions: t,
          width: 910,
          height: 685,
    ...
    c = r.extend(c, {
      ...
      inSignAttr: function(t) {
        if (t)
          return c.inArray(c.SIGN_ATTR, t)
      },
      generateAttrs: function(t) {
        for (var e = t.attributes, n = [], o = 0, i = e.length; o < i; o++)
          c.inSignAttr(e[o].nodeName.toLowerCase()) && n.push(e[o].nodeName.toLowerCase() + '="' + e[o].nodeValue + '"');
        return n.join(";")
      }
    });
    var l = -1 < navigator.userAgent.indexOf("Safari")
      , d = -1 < navigator.userAgent.indexOf("Chrome")
      , f = -1 < navigator.userAgent.indexOf("Firefox")
      , u = !!document.documentMode
      , h = !u && !!window.StyleMedia;
    d && (l = !1),
    c = r.extend(c, {
      isSafari: function() {
        return l
