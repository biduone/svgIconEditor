define("assets/magix/jquery.fileupload", ["jquery", "jquery", "assets/magix/jquery.ui.widget"], function(t, i, e) {
    !function(e) {
      "use strict";
      "function" == typeof define && define.amd ? define(["jquery"], e) : e("object" == typeof i ? t("jquery") : window.jQuery)
    }(function(l) {
      "use strict";
      var i = 0;
      l.ajaxTransport("iframe", function(n) {
        if (n.async) {
          var o, a, t, s = n.initialIframeSrc || "javascript:false;";
          return {
            send: function(e, r) {
              (o = l('<form style="display:none;"></form>')).attr("accept-charset", n.formAcceptCharset),
              t = /\?/.test(n.url) ? "&" : "?",
              "DELETE" === n.type ? (n.url = n.url + t + "_method=DELETE",
              n.type = "POST") : "PUT" === n.type ? (n.url = n.url + t + "_method=PUT",
              n.type = "POST") : "PATCH" === n.type && (n.url = n.url + t + "_method=PATCH",
              n.type = "POST"),
              a = l('<iframe src="' + s + '" name="iframe-transport-' + (i += 1) + '"></iframe>').bind("load", function() {
                var i, t = l.isArray(n.paramName) ? n.paramName : [n.paramName];
                ...
                o.prop("target", a.prop("name")).prop("action", n.url).prop("method", n.type),
                n.formData && l.each(n.formData, function(e, t) {
                  l('<input type="hidden"/>').prop("name", t.name).val(t.value).appendTo(o)
                }),
                n.fileInput && n.fileInput.length && "POST" === n.type && (i = n.fileInput.clone(),
                ...
                o.append(n.fileInput).prop("enctype", "multipart/form-data").prop("encoding", "multipart/form-data"),
                n.fileInput.removeAttr("form")),
                o.submit(),
                i && i.length && n.fileInput.each(function(e, t) {
                  e = l(i[e]);
                  l(t).prop("name", e.prop("name")).attr("form", e.attr("form")),
                  e.replaceWith(t)
                })
              }),
      ...
      l.ajaxSetup({
        converters: {
          ...
          "iframe xml": function(e) {
            e = e && e[0];
            return e && l.isXMLDoc(e) ? e : l.parseXML(e.XMLDocument && e.XMLDocument.xml || l(e.body).html())
          },
    ...
    function(e) {
      "use strict";
      "function" == typeof define && define.amd ? define(["jquery", "jquery.ui.widget"], e) : "object" == typeof i ? e(t("jquery"), t("assets/magix/jquery.ui.widget")) : e(window.jQuery)
    }(function(_) {
      "use strict";
      function e(i) {
        var r = "dragover" === i;
        return function(e) {
          ...
          t && -1 !== _.inArray("Files", t.types) && !1 !== this._trigger(i, _.Event(i, {
            delegatedEvent: e
          })) && (e.preventDefault(),
          r && (t.dropEffect = "copy"))
        }
      ...
      _.widget("blueimp.fileupload", {
        options: {
          ...
          add: function(e, t) {
            if (e.isDefaultPrevented())
              return !1;
            (t.autoUpload || !1 !== t.autoUpload && _(this).fileupload("option", "autoUpload")) && t.process().done(function() {
              t.submit()
            })
          },
          processData: !1,
        ...
        _getFormData: function(e) {
          var i;
          return "function" === _.type(e.formData) ? e.formData(e.form) : _.isArray(e.formData) ? e.formData : "object" === _.type(e.formData) ? (i = [],
        ...
        _initProgressListener: function(i) {
          ...
          e.upload && (_(e.upload).bind("progress", function(e) {
        ...
        _initXHRData: function(i) {
          var r, n = this, e = i.files[0], t = i.multipart || !_.support.xhrFileUpload, o = "array" === _.type(i.paramName) ? i.paramName[0] : i.paramName;
          i.headers = _.extend({}, i.headers),
          i.contentRange && (i.headers["Content-Range"] = i.contentRange),
          t && !i.blob && this._isInstanceOf("File", e) || (i.headers["Content-Disposition"] = 'attachment; filename="' + encodeURI(e.name) + '"'),
          t ? _.support.xhrFormDataFileUpload && (i.postMessage ? (r = this._getFormData(i),
          i.blob ? r.push({
            name: o,
            value: i.blob
          }) : _.each(i.files, function(e, t) {
            r.push({
              name: "array" === _.type(i.paramName) && i.paramName[e] || o,
              value: t
            })
          })) : (n._isInstanceOf("FormData", i.formData) ? r = i.formData : (r = new FormData,
          _.each(this._getFormData(i), function(e, t) {
            r.append(t.name, t.value)
          })),
          i.blob ? r.append(o, i.blob, e.name) : _.each(i.files, function(e, t) {
            (n._isInstanceOf("File", t) || n._isInstanceOf("Blob", t)) && r.append("array" === _.type(i.paramName) && i.paramName[e] || o, t, t.uploadName || t.name)
          })),
          i.data = r) : (i.contentType = e.type || "application/octet-stream",
          i.data = i.blob || e),
          i.blob = null
        },
        ...
        _getParamName: function(e) {
          var t = _(e.fileInput)
            , r = e.paramName;
          return r ? _.isArray(r) || (r = [r]) : (r = [],
          t.each(function() {
            for (var e = _(this), t = e.prop("name") || "files[]", i = (e.prop("files") || [1]).length; i; )
              r.push(t),
              --i
          }),
        ...
        _initFormSettings: function(e) {
          e.form && e.form.length || (e.form = _(e.fileInput.prop("form")),
          e.form.length || (e.form = _(this.options.fileInput.prop("form")))),
          e.paramName = this._getParamName(e),
          e.url || (e.url = e.form.prop("action") || location.href),
          e.type = (e.type || "string" === _.type(e.form.prop("method")) && e.form.prop("method") || "").toUpperCase(),
        ...
        _addConvenienceMethods: function(e, i) {
          ...
          i.process = function(e, t) {
            return (e || t) && (i._processQueue = this._processQueue = (this._processQueue || r([this])).then(function() {
              return i.errorThrown ? _.Deferred().rejectWith(n, [i]).promise() : r(arguments)
            }).then(e, t)),
            this._processQueue || r([this])
          }
          ,
          i.submit = function() {
            return "pending" !== this.state() && (i.jqXHR = this.jqXHR = !1 !== n._trigger("submit", _.Event("submit", {
              delegatedEvent: e
        ...
        _chunkedUpload: function(o, e) {
          ...
          var t, a, s = this, i = o.files[0], l = i.size, p = o.uploadedBytes, u = o.maxChunkSize || l, d = this._blobSlice, f = _.Deferred(), r = f.promise();
          return !(!(this._isXHRUpload(o) && d && (p || u < l)) || o.data) && (!!e || (l <= p ? (i.error = o.i18n("uploadedBytes"),
          this._getXHRPromise(!1, o.context, [null, "error", i.error])) : (a = function() {
            var r = _.extend({}, o)
              , n = r._progress.loaded;
            r.blob = d.call(i, p, p + u, i.type),
            r.chunkSize = r.blob.size,
            r.contentRange = "bytes " + p + "-" + (p + r.chunkSize - 1) + "/" + l,
            s._initXHRData(r),
            s._initProgressListener(r),
            t = (!1 !== s._trigger("chunksend", null, r) && _.ajax(r) || s._getXHRPromise(!1, r.context)).done(function(e, t, i) {
              p = s._getUploadedBytes(i) || p + r.chunkSize,
              n + r.chunkSize - r._progress.loaded && s._onProgress(_.Event("progress", {
                lengthComputable: !0,
        ...
        _onDone: function(e, t, i, r) {
          var n = r._progress.total
            , o = r._response;
          r._progress.loaded < n && this._onProgress(_.Event("progress", {
            lengthComputable: !0,
            loaded: n,
            total: n
          }), r),
        ...
        _onSend: function(e, t) {
          ...
          function i() {
            ...
            r = r || ((n || !1 === a._trigger("send", _.Event("send", {
              delegatedEvent: e
            }), s)) && a._getXHRPromise(!1, s.context, n) || a._chunkedUpload(s) || _.ajax(s)).done(function(e, t, i) {
              a._onDone(e, t, i, s)
            }).fail(function(e, t, i) {
              a._onFail(e, t, i, s)
            }).always(function(e, t, i) {
              if (a._onAlways(e, t, i, s),
              --a._sending,
              --a._active,
              s.limitConcurrentUploads && s.limitConcurrentUploads > a._sending)
          ...
          var r, n, o, a = this, s = a._getAJAXSettings(t);
          return this._beforeSend(e, s),
          this.options.sequentialUploads || this.options.limitConcurrentUploads && this.options.limitConcurrentUploads <= this._sending ? ((t = 1 < this.options.limitConcurrentUploads ? (o = _.Deferred(),
          this._slots.push(o),
          o.then(i)) : (this._sequence = this._sequence.then(i, i),
          this._sequence)).abort = function() {
            return n = [void 0, "abort", "abort"],
            r ? r.abort() : (o && o.rejectWith(s.context, n),
            i())
          }
          ,
        ...
        _onAdd: function(r, n) {
          var o, e, a, t, s = this, l = !0, i = _.extend({}, this.options, n), p = n.files, u = p.length, d = i.limitMultiFileUploads, f = i.limitMultiFileUploadSize, c = i.limitMultiFileUploadSizeOverhead, h = 0, g = this._getParamName(i), m = 0;
          if (!u)
            return !1;
          if (f && void 0 === p[0].size && (f = void 0),
          (i.singleFileUploads || d || f) && this._isXHRUpload(i))
            if (i.singleFileUploads || f || !d)
              if (!i.singleFileUploads && f)
                ...
                t = 0; t < u; t += 1)
                  h += p[t].size + c,
                  (t + 1 === u || h + p[t + 1].size + c > f || d && d <= t + 1 - m) && (a.push(p.slice(m, t + 1)),
        ...
        _handleFileTreeEntry: function(t, i) {
          ...
          var e, n = this, o = _.Deferred(), a = function() {
            e.readEntries(function(e) {
              e.length ? (s = s.concat(e),
              a()) : (e = s,
          ...
          o.resolve(t._file)) : t.file(function(e) {
            e.relativePath = i,
            o.resolve(e)
          }, r) : t.isDirectory ? (e = t.createReader(),
          a()) : o.resolve([]),
          o.promise()
        },
        ...
        _getDroppedFiles: function(e) {
          var t = (e = e || {}).items;
          return t && t.length && (t[0].webkitGetAsEntry || t[0].getAsEntry) ? this._handleFileTreeEntries(_.map(t, function(e) {
            var t;
        ...
        _getSingleFileInputFiles: function(e) {
          ...
          if ((t = _.makeArray(e.prop("files"))).length)
            void 0 === t[0].name && t[0].fileName && _.each(t, function(e, t) {
              t.name = t.fileName,
              t.size = t.fileSize
            });
          else {
        ...
        _getFileInputFiles: function(e) {
          return e instanceof _ && 1 !== e.length ? _.when.apply(_, _.map(e, this._getSingleFileInputFiles)).then(function() {
            return Array.prototype.concat.apply([], arguments)
        ...
        _onChange: function(t) {
          ...
          this._getFileInputFiles(r.fileInput).always(function(e) {
            ...
            !1 !== i._trigger("change", _.Event("change", {
              delegatedEvent: t
            }), r) && i._onAdd(t, r)
          })
        },
        _onPaste: function(e) {
          ...
          t && t.length && (_.each(t, function(e, t) {
            t = t.getAsFile && t.getAsFile();
            t && i.files.push(t)
          }),
          !1 !== this._trigger("paste", _.Event("paste", {
            delegatedEvent: e
          }), i) && this._onAdd(e, i))
        },
        _onDrop: function(t) {
          ...
          this._getDroppedFiles(e).always(function(e) {
            r.files = e,
            !1 !== i._trigger("drop", _.Event("drop", {
              delegatedEvent: t
            }), r) && i._onAdd(t, r)
          }))
        },
        ...
        _initEventHandlers: function() {
          ...
          _.support.fileInput && this._on(this.options.fileInput, {
        ...
        _initSpecialOptions: function() {
          var e = this.options;
          void 0 === e.fileInput ? e.fileInput = this.element.is('input[type="file"]') ? this.element : this.element.find('input[type="file"]') : e.fileInput instanceof _ || (e.fileInput = _(e.fileInput)),
        ...
        _isRegExpOption: function(e, t) {
          return "url" !== e && "string" === _.type(t) && /^\/.*\/[igm]{0,3}$/.test(t)
        },
        ...
        send: function(t) {
          if (t && !this.options.disabled) {
            if (t.fileInput && !t.files) {
              var i, r, n = this, o = _.Deferred(), e = o.promise();
              ...
              this._getFileInputFiles(t.fileInput).always(function(e) {
                r || (e.length ? (t.files = e,
                (i = n._onSend(null, t)).then(function(e, t, i) {
                  o.resolve(e, t, i)
                }, function(e, t, i) {
                  o.reject(e, t, i)
                })) : o.reject())
            ...
            if (t.files = _.makeArray(t.files),
            t.files.length)
