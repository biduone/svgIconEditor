define("assets/magix/dialog", ["magix", "jquery"], function(t, o, i) {
    ...
    i.exports = a.View.extend({
      ...
      render: function() {
        ...
        t.view && (t.content = '<div class="spinner" style="top:0px;"><div class="three-bounce"><div class="one"></div><div class="two"></div><div class="three"></div></div></div>');
        var i = d.tmpl(o.tmpl)({
          id: o.id,
          options: t
        });
        ...
        !t.view || (e = a.Vframe.get("body_" + o.id)) && e.mountView(t.view, t.viewOptions),
        t.mask && (e = 0 < d(".mp-e2e-mask").length,
        s.before('<div id="mask_' + o.id + '" class="mp-e2e-mask" />'),
        e && d("#mask_" + o.id).attr("style", "opacity: 0 !important"),
        t.maskClickClose || d("#mask_" + o.id).on("click", function(t) {
          d.contains(s, t.target) || o.close()
        })),
        o.adjust(s, t),
        d(window).off("resize.dialog").on("resize.dialog", function(t) {
          var o, i;
          o = n,
          clearTimeout(o.tId),
        ...
        d(document).off("keydown.dialog").on("keydown.dialog", function(t) {
      ...
      checkScale: function() {
        var t, o = d(window).height(), i = this.$options.height, e = d("#" + this.id);
        o < i && (t = ((o - 50) / i).toFixed(2),
      ...
      msgbox: function(t) {
        ...
        var i = a.guid("dlg_")
          , t = a.Vframe.root();
        return d("body").append('<div id="' + i + '" class="mp-e2e-dialog" />'),
        t.mountVframe(i, "assets/magix/dialog", o).$v
      }
    })
  });
