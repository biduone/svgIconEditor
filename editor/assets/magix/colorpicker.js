    ...
    e.exports = t.extend({
      ...
      render: function() {
        ...
        var e = r("#slide_" + t.id)
          , i = r("#cpicker_" + t.id);
        "SVG" == c ? (o = i,
        e.append('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%"><defs><linearGradient id="gradient-hsv" x1="0%" y1="100%" x2="0%" y2="0%"><stop offset="0%" stop-color="#FF0000" stop-opacity="1"></stop><stop offset="13%" stop-color="#FF00FF" stop-opacity="1"></stop><stop offset="25%" stop-color="#8000FF" stop-opacity="1"></stop><stop offset="38%" stop-color="#0040FF" stop-opacity="1"></stop><stop offset="50%" stop-color="#00FFFF" stop-opacity="1"></stop><stop offset="63%" stop-color="#00FF40" stop-opacity="1"></stop><stop offset="75%" stop-color="#0BED00" stop-opacity="1"></stop><stop offset="88%" stop-color="#FFFF00" stop-opacity="1"></stop><stop offset="100%" stop-color="#FF0000" stop-opacity="1"></stop></linearGradient></defs><rect x="0" y="0" width="100%" height="100%" fill="url(#gradient-hsv)"></rect></svg>'),
        o.append('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%"><defs><lineargradient id="gradient-black" x1="0%" y1="100%" x2="0%" y2="0%"><stop offset="0%" stop-color="#000000" stop-opacity="1"></stop><stop offset="100%" stop-color="#CC9A81" stop-opacity="0"></stop></lineargradient><lineargradient id="gradient-white" x1="0%" y1="100%" x2="100%" y2="100%"><stop offset="0%" stop-color="#FFFFFF" stop-opacity="1"></stop><stop offset="100%" stop-color="#CC9A81" stop-opacity="0"></stop></lineargradient></defs><rect x="0" y="0" width="100%" height="100%" fill="url(#gradient-white)"></rect><rect x="0" y="0" width="100%" height="100%" fill="url(#gradient-black)"></rect></svg>')) : (i = i,
        e = e,
        document.namespaces.mxv || document.namespaces.add("mxv", "urn:schemas-microsoft-com:vml", "#default#VML"),
        e.html('<div style="position: relative; width: 100%; height: 100%"><mxv:rect style="position: absolute; top: 0; left: 0; width: 100%; height: 100%" stroked="f" filled="t"><mxv:fill type="gradient" method="none" angle="0" color="red" color2="red" colors="8519f fuchsia;.25 #8000ff;24903f #0040ff;.5 aqua;41287f #00ff40;.75 #0bed00;57671f yellow"></mxv:fill></mxv:rect></div>'),
        i.html('<div style="position: relative; width: 100%; height: 100%"><mxv:rect style="position: absolute; left: -1px; top: -1px; width: 101%; height: 101%" stroked="f" filled="t"><mxv:fill type="gradient" method="none" angle="270" color="#FFFFFF" opacity="100%" color2="#CC9A81" o:opacity2="0%"></mxv:fill></mxv:rect><mxv:rect style="position: absolute; left: 0px; top: 0px; width: 100%; height: 101%" stroked="f" filled="t"><mxv:fill type="gradient" method="none" angle="0" color="#000000" opacity="100%" color2="#CC9A81" o:opacity2="0%"></mxv:fill></mxv:rect></div>')),
        t.setColor(t.$color),
        t.show()
      },
      setHSV: function(t, o) {
        ...
        r("#val_" + e.id).val(s),
        o || (r("#shortcuts_" + e.id + " li").removeClass(d),
      ...
      setColor: function(t) {
        var o, e = parseInt(t.substr(1, 2), 16), i = parseInt(t.substr(3, 2), 16), s = parseInt(t.substr(5, 2), 16), i = (o = e,
        t = i,
        e = s,
        o /= 255,
        t /= 255,
        e /= 255,
        {
          h: (0 == (s = (i = Math.max(o, t, e)) - Math.min(o, t, e)) ? null : i == o ? (t - e) / s + (t < e ? 6 : 0) : i == t ? (e - o) / s + 2 : (o - t) / s + 4) % 6 * 60,
          s: 0 == s ? 0 : s / i,
          v: i
        });
        this.setHSV(i)
      ...
      "colorZoneClick<click>": function(t) {
        var o = r(t.current).offset()
          , e = (t.pageX - o.left) / 196
          , o = (196 - (t.pageY - o.top)) / 196;
        this.setHSV({
          h: this.$hsv.h,
          s: e,
          v: o
      ...
      "pickShortcuts<click>": function(t) {
        this.setColor(t.params.color),
        r(t.current).addClass(d)
      },
      "enter<click>": function(t) {
        var o = r("#val_" + this.id);
        this.$picked && s.toTry(this.$picked, {
          color: o.val()
        }),
        this.hide(),
        t.preventDefault()
      ...
      show: function(t, o) {
        var e = "cp_" + (e = o.ownerNodeId)
          , i = s.Vframe.get(e);
        i ? i.invoke("show") : (r("body").append('<div id="' + e + '" />'),
        t.owner.mountVframe(e, "assets/magix/colorpicker", o))
      }
    })
  });
